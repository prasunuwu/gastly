# Gastly-Privacy-Policy

## **Gastly's Privacy Policy**
### By using Gastly you accept with its privacy policy and [discord.com/terms](https://discord.com/terms) & [discord.com/guidelines](https://discord.com/guidelines)

## 1. What does it store?

 - Server IDs for servers data(prefixes, settings)
 - User IDs for whitelisted users
 - Channel IDs to send action logs
...
#### 1. It stores server IDs, channel IDs settings and data because:
...
- Join our [Support Server](https://discord.gg/zX34dtmZqD) on discord
- Server invite invalid or channels locked ? You can contact me via my discord username: [Prasun#5396](https://discord.com/users/1053255772949196820)
